...
If version or build is missing, ask the planner for a suggestion first:
...
prints a suggestion, ask whether to use that exact channel, version, and build.

## Phase 1: Clean dry run

Do not create a GitHub Release, tag, or version commit in phase 1.
