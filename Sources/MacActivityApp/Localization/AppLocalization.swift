...
enum AppLocalization {
    ...
    enum Key: String, CaseIterable {
        ...
        case statusSummaryEmpty = "status.summary.empty"
        case statusAccessibilityMetric = "status.accessibility.metric"
        case statusAccessibilityNetwork = "status.accessibility.network"
        case statusAccessibilityFan = "status.accessibility.fan"
        case statusMetricCPUShort = "status.metric.cpu.short"
        case statusMetricGPUShort = "status.metric.gpu.short"
        case statusMetricDiskShort = "status.metric.disk.short"
        case statusMetricSwapShort = "status.metric.swap.short"
        case statusMetricMemoryShort = "status.metric.memory.short"
        case statusMetricVRAMShort = "status.metric.vram.short"
        case statusMetricBatteryShort = "status.metric.battery.short"
        case statusMetricTemperatureCPUShort = "status.metric.temperature.cpu.short"
        case statusMetricTemperatureBatteryShort = "status.metric.temperature.battery.short"
        case statusMetricFanShort = "status.metric.fan.short"
        case statusMetricFanUnit = "status.metric.fan.unit"
