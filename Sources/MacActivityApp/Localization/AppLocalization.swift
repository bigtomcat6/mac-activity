...
enum AppLocalization {
    ...
    enum Key: String, CaseIterable {
        ...
        case dashboardTabEnergyImpact = "dashboard.tab.energyImpact"
        case dashboardTabAudio = "dashboard.tab.audio"
        ...
        case audioDeviceUnavailable = "audio.device.unavailable"
        case audioDeviceReadFailed = "audio.device.readFailed"
        case audioDeviceWriteFailed = "audio.device.writeFailed"
        case audioRetry = "audio.action.retry"
        case audioReset = "audio.action.reset"
        case audioProcessesEmpty = "audio.process.empty"
        case audioProcessPreparing = "audio.process.preparing"
        case audioProcessRebuilding = "audio.process.rebuilding"
        case audioProcessActive = "audio.process.active"
        ...
        case audioAccessChecking = "audio.access.checking"
        case audioAccessPermissionRequired = "audio.access.permissionRequired"
        case audioAccessFailed = "audio.access.failed"
        case audioAccessOpenSettings = "audio.access.openSettings"
        case audioAccessPermissionTitle = "audio.access.permissionTitle"
        case audioAccessPermissionDescription = "audio.access.permissionDescription"
        case audioAccessGrant = "audio.access.grant"
        case audioAccessUnavailableTitle = "audio.access.unavailableTitle"
        ...
        case preferencesCategoryGeneral = "preferences.category.general"
        case preferencesCategoryMenuBar = "preferences.category.menuBar"
        case preferencesCategoryMonitoring = "preferences.category.monitoring"
        case preferencesCategoryCleanup = "preferences.category.cleanup"
        case preferencesCategoryAboutUpdates = "preferences.category.aboutUpdates"
        ...
        case diskCleanupSubtitleDeleteFailed = "diskCleanup.subtitle.failed.unableToDeleteItems"
